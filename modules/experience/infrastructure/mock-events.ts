...
const MOCK_EVENTS: DashboardEvent[] = Array.from({ length: 80 }, (_, i) => makeItem(i));
// Ensure clear mock cases for tab/register flow.
if (MOCK_EVENTS[0]) {
  MOCK_EVENTS[0].date = "Oct 15, 2026";
  MOCK_EVENTS[0].isRegistered = false;
  MOCK_EVENTS[0].isHistory = false;
}
if (MOCK_EVENTS[1]) {
  MOCK_EVENTS[1].date = "Nov 5, 2026";
  MOCK_EVENTS[1].isRegistered = false;
  MOCK_EVENTS[1].isHistory = false;
}
if (MOCK_EVENTS[2]) {
  MOCK_EVENTS[2].date = "Dec 5, 2025";
  MOCK_EVENTS[2].isRegistered = false;
  MOCK_EVENTS[2].isHistory = true;
}
if (MOCK_EVENTS[3]) {
  MOCK_EVENTS[3].date = "Oct 16, 2025";
  MOCK_EVENTS[3].isRegistered = false;
  MOCK_EVENTS[3].isHistory = true;
}
if (MOCK_EVENTS[4]) {
  MOCK_EVENTS[4].date = "Jan 20, 2026";
  MOCK_EVENTS[4].isRegistered = true;
  MOCK_EVENTS[4].isHistory = false;
}
if (MOCK_EVENTS[5]) {
  MOCK_EVENTS[5].date = "Feb 10, 2026";
  MOCK_EVENTS[5].isRegistered = true;
  MOCK_EVENTS[5].isHistory = false;
}
