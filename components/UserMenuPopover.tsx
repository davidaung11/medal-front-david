        ...
        <div className="absolute bottom-0 left-full z-[12010] ml-3 w-[330px] rounded-xl border border-slate-200 bg-white p-3 shadow-xl">
          ...
          <div className="space-y-1">
            ...
            <button
              ...
              onClick={onLogout}
              disabled={loggingOut}
              className="flex w-full items-center gap-3 rounded-lg px-2 py-2 text-left text-[14px] text-slate-600 transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-60"
            >
              <LogOut size={18} />
